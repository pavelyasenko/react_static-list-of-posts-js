...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({coments:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),O.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.lengh===0?e.map(t=>O.jsx(Lc,{coment:t},t.id)):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})}),Mc=({post:e})=>{e.title,e.body,e.id},Rc=({users:e,posts:t,comments:i})=>O.jsx("div",{className:"PostList",children:t.map(n=>{const a=e.find(o=>o.id===n.userId),u=i.filter(o=>t.id===o.postId);return O.jsx(Mc,{post:{...t,users:a,comments:u}})})}),Dc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Rc,{posts:Cc,comments:zc,users:Nc})]});em(document.getElementById("root")).render(O.jsx(Dc,{}));
